(() => {
    const modal = document.querySelector("[data-expert-public-details-modal]");
    const triggers = Array.from(document.querySelectorAll("[data-expert-public-details-open]"));
