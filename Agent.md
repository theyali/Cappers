...
-Без style в templates и без тегов style в templates
-Все стили для адаптивов держи в mobile.css и не добавлять media query в main.css
-Остерегайся дубликатов кода например если ты видишь что один и тот же блок, row, html код используется везде то вынеси его в общий файл и выполняя include подключай дабы избежать дубликатов кода 