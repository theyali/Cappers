...
Главный принцип: быстрый купон не ломать. `coupon-panel` остается быстрым способом создать прогноз без описания и обложки. Новая страница нужна для полного прогноза, где VIP получает расширенные поля.
