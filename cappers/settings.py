...
MEDIA_WEBP_CONVERSION_ENABLED = env_bool("MEDIA_WEBP_CONVERSION_ENABLED", True)
MEDIA_WEBP_QUALITY = env_int("MEDIA_WEBP_QUALITY", 82)
MEDIA_WEBP_MAX_WIDTH = env_int("MEDIA_WEBP_MAX_WIDTH", 1920)
MEDIA_WEBP_MAX_HEIGHT = env_int("MEDIA_WEBP_MAX_HEIGHT", 1920)
MEDIA_WEBP_DELETE_ORIGINAL = env_bool("MEDIA_WEBP_DELETE_ORIGINAL", True)
...
NEUROKEFF_GAME_PREDICTIONS_ENDPOINT = os.getenv(
    "NEUROKEFF_GAME_PREDICTIONS_ENDPOINT",
    "games/predictions",
)
NEUROKEFF_GAME_PREDICTIONS_STALE_SECONDS = env_int(
    "NEUROKEFF_GAME_PREDICTIONS_STALE_SECONDS",
    3600,
)
