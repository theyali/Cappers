...
Ниже 11 шагов для выноса roulette в отдельный сервис внутри `cabinet` и исправления багов со спамом вращений, неверным подсчетом попыток и кликом по карточке выигрыша.
...
## 6. Исправить frontend state machine в `front/static/front/js/roulette.js`
...
## 7. Запретить новый spin при открытой карточке выигрыша
...
## 9. Физически перенести отмеченные roulette-файлы в пакет
...
## 10. Обновить импорты после переноса
...
## 11. Добавить фронтовую защиту от флуда с видимым состоянием кнопки
